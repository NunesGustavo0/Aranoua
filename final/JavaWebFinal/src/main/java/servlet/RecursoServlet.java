...
public class RecursoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (salvar != null) {
                ...
                recursos.setEquipamento(recursos.getEquipamento("equipamento"));
                ...
                out.println("<a href='recursos'>Voltar</a>");
    ...
    private void listarRecurso(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            for (Recursos recursos1 : recursos) {
                out.println("<tr><td><a href='recursos?acao=consultar&numeroTombo=" + recursos1.getNumeroTombo() + "'>" +
            ...
            out.println("</table>");
            out.println("<br><br>");
            out.println("<a href='recursos?acao=cadastrar'>Cadastrar Recursos</a>");
    ...
    private void consultarRecurso(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<a href='recursos?acao=alterar&numeroTombo=" + recursos.getNumeroTombo() + "'>Alterar</a>");
            out.println("<a href='recursos?acao=excluir&numeroTombo=" + recursos.getNumeroTombo() + "'>Excluir</a>");
            out.println("<a href='recursos'>Voltar</a>");
